...
class WatcherHandler(FileSystemEventHandler):
    ...
    def process_file(self, file_path):
        ...
        try:
            result = subprocess.run([EXIFTOOL_PATH, "-charset", "UTF8", file_path], capture_output=True, text=True, encoding="utf-8") #TODO Gestion de l'encodage, certains fichiers nécessitent de supprimer l'encodage
